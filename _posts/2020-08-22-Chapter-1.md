...
{% highlight %}
for loop is used when the number is known before entering the loop.
while loop is used when the number is not known before entering the loop.
{% endhighlight %}
...
{% highlight %}
"%currVal% occurs %cnt% times" would not show up on cli and wait an input until user enter an End-of-File.
{% endhighlight %}
...
{% highlight %}
"%currVal% occurs %cnt% times" would show up on cli. Last line would not show up on cli until user enter an End-of-File.
{% endhighlight %}
